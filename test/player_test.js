...
describe('PLAYER METHODS', function () {
  describe('validateLocation', function () {
    var validateLocation = require('../testing_demo/game_logic/player_methods.js').validateLocation;
    var player;
  ...
  describe('validateLocations', function () {
    var validateLocations = require('../testing_demo/game_logic/player_methods.js').validateLocations;
    var player;
  ...
  describe('placeShip', function () {
    var placeShip = require('../testing_demo/game_logic/player_methods.js').placeShip;
    var player;
